...
import com.hzp.lib_common.flutter.HiFlutterCacheManager
...
import com.hzp.lib_library.log.HiLogConfig.JsonParser
...
//        HiFlutterCacheManager.instance?.preLoadDartVM(this)
    ...
    private fun initConfig() {
        HiConfig.instance.init(object : com.hzp.lib_config.core.JsonParser {
